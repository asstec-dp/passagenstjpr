<?php
	...
	if($btnCadPassagem){		
		...
		$result_passagem = "INSERT INTO tbl_passagem (id_viagem, id_pessoa, id_item, data_compra, origem, destino, data_ida, data_retorno, companhia, localizador, tarifa_voucher, taxas_voucher, classe, status_passagem)VALUES (
		'" .$dados['id_viagem']. "',
		'" .$dados['id_pessoa']. "',
		'" .$dados['id_item']. "',
		'" .$dados['data_compra']. "',
		...
		if(pg_insert($conn, $result_passagem)){
		...
		<section class="col-md-auto">	
            <div class="content-center" id="conteiner">
                ...
                <form method="POST" action="">
                            <div class="row">
                                <h1 class="h1-side">Cadastro de Passagem</h1>
                            </div>
                            <div class="row">
                                <!-- Select Viagem -->
                                <div class="col-md-3">
                                    <?php
                                        $result_viagem = "SELECT id_viagem, id_contrato, protocolo_compra, evento FROM tbl_viagem
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-4">
                                        <input type="submit" id = "btnCadPassagem" value="Salvar" name="btnCadPassagem"></input>
                                    </div>
                                    <div class="col-md-4">  

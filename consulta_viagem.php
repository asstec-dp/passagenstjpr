                ...
                if (isset($_POST['search'])) {
                    ...
                    if (strlen($valor) > 2) {
                        ...
                        $result_viagem = "SELECT * FROM tbl_viagem
                                                ...
                                                ON tbl_viagem.id_contrato = tbl_contrato.id_contrato
                                                WHERE protocolo_compra = '$valor'
                        ...
                        while ($row_viagem = $resultado_viagem->fetch(PDO::FETCH_ASSOC)) {
                            echo '<div id="menu"><a href="cadpagamento.php"><font color="#113141">'
                                . "<strong>Procolo:</strong> " . $row_viagem['protocolo_compra']
                                . " - <strong>Grau:</strong> " . $row_viagem['grau']
                                . "º - <strong>N. Contrato:</strong> " . $row_viagem['num_contrato']
                                . " - <strong>Contratada:</strong> " . $row_viagem['contratada']
                                . "</font></a></div>";
                        }
                    } else {

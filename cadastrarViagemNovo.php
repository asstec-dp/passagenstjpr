                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <div class="col-md-4"> 
                            ...
                            $sql = "SELECT * FROM tbl_contrato ORDER BY id_contrato";
                                ...
                                if (pg_num_rows($resultado)!=0){
                                    echo '<select class="custom-select" name="id_contrato" id="id_contrato">
                                    <option value="id_contrato" selected="selected">Contrato</option>';
                        ...
                        <div class="col-md-4">
                            ...
                            echo '<elect class="custom-select" name="id_usuario" id="id_usuario">
                            <option selectec enabled name="id_usuario" value="id_usuario">'.$_SESSION['nome_completo'].'</option>';
                            }
					        ?>
                        </div>
